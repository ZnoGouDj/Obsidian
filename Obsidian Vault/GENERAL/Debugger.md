<p style="color: mediumvioletred; font-weight: bold; text-align: center;">Ставим брейкпойнт, и когда программа дойдет до этого места, она ОСТАНОВИТ скрипт и мы сможем посмотреть на текущие данные</p>
