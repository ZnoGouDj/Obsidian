<span style="font-weight: bold; color: #FE5C2B;">Эндпоинт</span> — принимает параметры и возвращают данные Клиенту. Это обращение к маршруту отдельным [[HTTP]] методом.  
